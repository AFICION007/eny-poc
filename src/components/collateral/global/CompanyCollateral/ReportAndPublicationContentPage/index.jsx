...
const REPORTS_AND_PUBLICATIONS = [
    {
        ...
        year: 2025,
        title: 'Avendus Eye FY2025 Edition',
        url: '/publications/avendus-eye/2025.pdf',
    },
    {
        category: 'avendus-eye',
        year: 2024,
        title: 'Avendus Eye FY2024 Edition',
        url: '/publications/avendus-eye/2024.pdf',
    },
    {
        category: 'avendus-eye',
        year: 2023,
        title: 'Avendus Eye FY2023 Insight',
        url: '/publications/avendus-eye/2023.pdf',
    },
    {
        category: 'avendus-eye',
        year: 2022,
        title: 'Avendus Eye FY2022 Recap',
    ...
    },
    {
        category: 'avendus-eye',
        year: 2023,
        title: 'Avendus Eye Special Edition 2023',
...
const ReportAndPublicationContentSection = () => {
    ...
    const filteredReports = useMemo(() => {
        ...
        const filteredByTab = REPORTS_AND_PUBLICATIONS.filter(report => report.category === tab);
