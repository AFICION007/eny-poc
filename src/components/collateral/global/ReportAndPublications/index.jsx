...
import { FileTextOutlined, ArrowRightOutlined, DownOutlined } from '@ant-design/icons';
...
const ReportAndPublicationSection = () => {
  ...
  const avendusReportTypes = [
    'Quarterly Result Updates', 'Half Updates', 'Annual Updates', 'Flash Report', 'Other'
  ];
  const analystReportTypes = [
    'Quarterly Result Updates', 'Half Updates', 'Annual Updates', 'Flash Report'
  ];
  ...
  return (
    <div className={styles.container}>
            ...
            <div className={styles.reportFilterRow}>
              ...
              <Dropdown overlay={reportTypeMenu} trigger={['click']}>
                <Button className={styles.dropdown}>
                  <span className={styles.dropdown_text}>{selectedReportType}</span>
                  <DownOutlined />
                </Button>
              </Dropdown>
              {/* {selectedReportType && (
                <Button
                  ...
                  onClick={() => handleReportTypeChange(null)}
                >
                  Clear
                </Button>
              )} */}
      ...
      <div className={!selectedReportType ?styles.reportsScrollWrapper:styles.reportsScrollWrapper_selected_report}>
